# llm-agent-post-processing Specification

## Purpose
Define the contract for agent-driven Gemini batch post-processing, state transitions, retries, and operator observability.
